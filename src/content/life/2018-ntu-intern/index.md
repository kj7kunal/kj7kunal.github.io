...
description: "Research intern experience at NTU ROSE Lab working on person re-identification and multi-object tracking"
date: 2018-08-01
tags: ["internship", "research", "computer-vision", "machine-learning", "singapore", "person-reid", "yolo", "pytorch"]
category: "life"
featured: true
---
...
1. Mental Workload Estimation [[Github]](https://github.com/kj7kunal/ML_Project)
...
1. **[RETRIEVAL] Person Detection**:
    ...
    ![Person Detection Demo](person_detect.gif)

2. **[RANKING] Target Extraction**:
...
![Person Tracking demo](person_track.gif)
